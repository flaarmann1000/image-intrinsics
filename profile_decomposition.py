#!/usr/bin/env python
"""
profile_decomposition.py — where does the decomposition's wall time actually go?
...
Examples
  ...
  python profile_decomposition.py --scene <view> --downsample 1 --n_train 100 --n_val 28
