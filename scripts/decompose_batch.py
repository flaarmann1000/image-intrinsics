#!/usr/bin/env python
"""
scripts/decompose_batch.py — standalone batch CT decomposition, for headless / VM runs
with wandb logging.
...
Example (GCE VM):
  WANDB_API_KEY=... python scripts/decompose_batch.py \
...
Add the relighting sweep + video to a batch that already ran (no re-optimization):
  python scripts/decompose_batch.py --runs_root /data/decomp/runs \
