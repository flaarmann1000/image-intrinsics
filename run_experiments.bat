...
if defined RUN_1 (
    ...
    for %%M in (%MESHES%) do (
        ...
        %PYTHON% %SCRIPT% --phase 1 --mesh %%M --shader all --width %WIDTH% --height %HEIGHT% --device %DEVICE% %SKIP% %MC_FLAG% %TR_FLAG%
...
if defined RUN_2A (
    ...
    for %%M in (%MESHES%) do (
        for %%S in (%SHADERS%) do (
            ...
            %PYTHON% %SCRIPT% --phase 2 --mesh %%M --shader %%S --n-iter %N_ITER% --width %WIDTH% --height %HEIGHT% --device %DEVICE% %SKIP% %MC_FLAG% %TR_FLAG%
    ...
    if %N_SH% gtr 0 (
        for %%M in (%MESHES%) do (
            for %%P in (albedo sh metallic roughness) do (
                ...
                %PYTHON% %SCRIPT% --phase 2 --mesh %%M --shader ct_sh --opt-params %%P --n-iter %N_ITER% --width %WIDTH% --height %HEIGHT% --device %DEVICE% %SKIP% %MC_FLAG% %TR_FLAG%
        ...
        for %%M in (%MESHES%) do (
            for %%P in (albedo sh shininess ks) do (
                ...
                %PYTHON% %SCRIPT% --phase 2 --mesh %%M --shader phong_sh --opt-params %%P --n-iter %N_ITER% --width %WIDTH% --height %HEIGHT% --device %DEVICE% %SKIP% %MC_FLAG% %TR_FLAG%
                if errorlevel 1 ( echo ERROR & exit /b 1 )
            )
        )
    )
    ...
    if %N_ENV% gtr 0 (
        for %%M in (%MESHES%) do (
            for %%P in (albedo env metallic roughness) do (
                ...
                %PYTHON% %SCRIPT% --phase 2 --mesh %%M --shader ct_env --opt-params %%P --n-iter %N_ITER% --width %WIDTH% --height %HEIGHT% --device %DEVICE% %SKIP% %MC_FLAG% %TR_FLAG%
                if errorlevel 1 ( echo ERROR & exit /b 1 )
            )
        )
        for %%M in (%MESHES%) do (
            for %%P in (albedo env shininess ks) do (
                ...
                %PYTHON% %SCRIPT% --phase 2 --mesh %%M --shader phong_env --opt-params %%P --n-iter %N_ITER% --width %WIDTH% --height %HEIGHT% --device %DEVICE% %SKIP% %MC_FLAG% %TR_FLAG%
                if errorlevel 1 ( echo ERROR & exit /b 1 )
            )
        )
    )
...
if defined RUN_2C (
    ...
    if %N_SH% gtr 0 (
        for %%M in (%MESHES%) do (
            ...
            %PYTHON% %SCRIPT% --phase 2 --mesh %%M --shader ct_sh --opt-params sh,metallic,roughness    --n-iter %N_ITER% --width %WIDTH% --height %HEIGHT% --device %DEVICE% %SKIP% %MC_FLAG% %TR_FLAG%
            set /a RUN_NUM+=1
            echo [!RUN_NUM!/%TOTAL_RUNS%] ct_sh  opt=albedo,metallic,roughness  mesh=%%M
            %PYTHON% %SCRIPT% --phase 2 --mesh %%M --shader ct_sh --opt-params albedo,metallic,roughness --n-iter %N_ITER% --width %WIDTH% --height %HEIGHT% --device %DEVICE% %SKIP% %MC_FLAG% %TR_FLAG%
            set /a RUN_NUM+=1
            echo [!RUN_NUM!/%TOTAL_RUNS%] ct_sh  opt=albedo,sh,roughness  mesh=%%M
            %PYTHON% %SCRIPT% --phase 2 --mesh %%M --shader ct_sh --opt-params albedo,sh,roughness       --n-iter %N_ITER% --width %WIDTH% --height %HEIGHT% --device %DEVICE% %SKIP% %MC_FLAG% %TR_FLAG%
            set /a RUN_NUM+=1
            echo [!RUN_NUM!/%TOTAL_RUNS%] ct_sh  opt=albedo,sh,metallic  mesh=%%M
            %PYTHON% %SCRIPT% --phase 2 --mesh %%M --shader ct_sh --opt-params albedo,sh,metallic        --n-iter %N_ITER% --width %WIDTH% --height %HEIGHT% --device %DEVICE% %SKIP% %MC_FLAG% %TR_FLAG%
        )
        for %%M in (%MESHES%) do (
            set /a RUN_NUM+=1
            echo [!RUN_NUM!/%TOTAL_RUNS%] phong_sh  opt=sh,shininess,ks  mesh=%%M
            %PYTHON% %SCRIPT% --phase 2 --mesh %%M --shader phong_sh --opt-params sh,shininess,ks        --n-iter %N_ITER% --width %WIDTH% --height %HEIGHT% --device %DEVICE% %SKIP% %MC_FLAG% %TR_FLAG%
            set /a RUN_NUM+=1
            echo [!RUN_NUM!/%TOTAL_RUNS%] phong_sh  opt=albedo,shininess,ks  mesh=%%M
            %PYTHON% %SCRIPT% --phase 2 --mesh %%M --shader phong_sh --opt-params albedo,shininess,ks    --n-iter %N_ITER% --width %WIDTH% --height %HEIGHT% --device %DEVICE% %SKIP% %MC_FLAG% %TR_FLAG%
            set /a RUN_NUM+=1
            echo [!RUN_NUM!/%TOTAL_RUNS%] phong_sh  opt=albedo,sh,ks  mesh=%%M
            %PYTHON% %SCRIPT% --phase 2 --mesh %%M --shader phong_sh --opt-params albedo,sh,ks           --n-iter %N_ITER% --width %WIDTH% --height %HEIGHT% --device %DEVICE% %SKIP% %MC_FLAG% %TR_FLAG%
            set /a RUN_NUM+=1
            echo [!RUN_NUM!/%TOTAL_RUNS%] phong_sh  opt=albedo,sh,shininess  mesh=%%M
            %PYTHON% %SCRIPT% --phase 2 --mesh %%M --shader phong_sh --opt-params albedo,sh,shininess    --n-iter %N_ITER% --width %WIDTH% --height %HEIGHT% --device %DEVICE% %SKIP% %MC_FLAG% %TR_FLAG%
        )
    )
    ...
    if %N_ENV% gtr 0 (
        for %%M in (%MESHES%) do (
            ...
            %PYTHON% %SCRIPT% --phase 2 --mesh %%M --shader ct_env --opt-params env,metallic,roughness    --n-iter %N_ITER% --width %WIDTH% --height %HEIGHT% --device %DEVICE% %SKIP% %MC_FLAG% %TR_FLAG%
            set /a RUN_NUM+=1
            echo [!RUN_NUM!/%TOTAL_RUNS%] ct_env  opt=albedo,metallic,roughness  mesh=%%M
            %PYTHON% %SCRIPT% --phase 2 --mesh %%M --shader ct_env --opt-params albedo,metallic,roughness --n-iter %N_ITER% --width %WIDTH% --height %HEIGHT% --device %DEVICE% %SKIP% %MC_FLAG% %TR_FLAG%
            set /a RUN_NUM+=1
            echo [!RUN_NUM!/%TOTAL_RUNS%] ct_env  opt=albedo,env,roughness  mesh=%%M
            %PYTHON% %SCRIPT% --phase 2 --mesh %%M --shader ct_env --opt-params albedo,env,roughness      --n-iter %N_ITER% --width %WIDTH% --height %HEIGHT% --device %DEVICE% %SKIP% %MC_FLAG% %TR_FLAG%
            set /a RUN_NUM+=1
            echo [!RUN_NUM!/%TOTAL_RUNS%] ct_env  opt=albedo,env,metallic  mesh=%%M
            %PYTHON% %SCRIPT% --phase 2 --mesh %%M --shader ct_env --opt-params albedo,env,metallic       --n-iter %N_ITER% --width %WIDTH% --height %HEIGHT% --device %DEVICE% %SKIP% %MC_FLAG% %TR_FLAG%
        )
        for %%M in (%MESHES%) do (
            set /a RUN_NUM+=1
            echo [!RUN_NUM!/%TOTAL_RUNS%] phong_env  opt=env,shininess,ks  mesh=%%M
            %PYTHON% %SCRIPT% --phase 2 --mesh %%M --shader phong_env --opt-params env,shininess,ks      --n-iter %N_ITER% --width %WIDTH% --height %HEIGHT% --device %DEVICE% %SKIP% %MC_FLAG% %TR_FLAG%
            set /a RUN_NUM+=1
            echo [!RUN_NUM!/%TOTAL_RUNS%] phong_env  opt=albedo,shininess,ks  mesh=%%M
            %PYTHON% %SCRIPT% --phase 2 --mesh %%M --shader phong_env --opt-params albedo,shininess,ks   --n-iter %N_ITER% --width %WIDTH% --height %HEIGHT% --device %DEVICE% %SKIP% %MC_FLAG% %TR_FLAG%
            set /a RUN_NUM+=1
            echo [!RUN_NUM!/%TOTAL_RUNS%] phong_env  opt=albedo,env,ks  mesh=%%M
            %PYTHON% %SCRIPT% --phase 2 --mesh %%M --shader phong_env --opt-params albedo,env,ks         --n-iter %N_ITER% --width %WIDTH% --height %HEIGHT% --device %DEVICE% %SKIP% %MC_FLAG% %TR_FLAG%
            set /a RUN_NUM+=1
            echo [!RUN_NUM!/%TOTAL_RUNS%] phong_env  opt=albedo,env,shininess  mesh=%%M
            %PYTHON% %SCRIPT% --phase 2 --mesh %%M --shader phong_env --opt-params albedo,env,shininess  --n-iter %N_ITER% --width %WIDTH% --height %HEIGHT% --device %DEVICE% %SKIP% %MC_FLAG% %TR_FLAG%
        )
    )
)
    ...
    if %N_SH% gtr 0 (
        ...
        for %%M in (%MESHES%) do (
            for %%S in (%SH_SHADERS%) do (
                ...
                %PYTHON% %SCRIPT% --phase 2 --mesh %%M --shader %%S --lambda-white 0.1 --n-iter %N_ITER% --width %WIDTH% --height %HEIGHT% --device %DEVICE% %SKIP% %MC_FLAG% %TR_FLAG%
                if errorlevel 1 ( echo ERROR & exit /b 1 )
            )
        )
    )
    ...
    if %N_SH% gtr 0 (
        ...
        for %%M in (%MESHES%) do (
            for %%S in (%SH_SHADERS%) do (
                ...
                %PYTHON% %SCRIPT% --phase 2 --mesh %%M --shader %%S --lambda-sparse 0.1 --n-iter %N_ITER% --width %WIDTH% --height %HEIGHT% --device %DEVICE% %SKIP% %MC_FLAG% %TR_FLAG%
                if errorlevel 1 ( echo ERROR & exit /b 1 )
            )
        )
    )
    ...
    if %N_SH% gtr 0 (
        ...
        for %%M in (%MESHES%) do (
            for %%S in (%SH_SHADERS%) do (
                ...
                %PYTHON% %SCRIPT% --phase 2 --mesh %%M --shader %%S --lambda-tv 0.1 --n-iter %N_ITER% --width %WIDTH% --height %HEIGHT% --device %DEVICE% %SKIP% %MC_FLAG% %TR_FLAG%
                if errorlevel 1 ( echo ERROR & exit /b 1 )
            )
        )
    )
